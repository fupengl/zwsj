...
{
    public class ZhiDiShangYeDetailController : Controller
    {
        //
        // GET: /ZhiDiShangYeDetail/
        ...
        public JObject GetShangYeJiChuXinXi(string wuYeBianHao)
        {
            return _wuYeService.GetJiChuXinXi(WuYeYongTus.ShangYe.ToString(), wuYeBianHao);
        }

        public JArray GetImage(string wuYeBianHao)
        {
            var jArray = new JArray();
            var query = _wuYeService.WebGetImageFileName(WuYeYongTus.ShangYe.ToString(), wuYeBianHao);
        ...
        public JObject GetJiaGeZouShi(string wuYeBianHao)
        {
            ...
            var query = _wuYeService.GetJiZhunJia(WuYeYongTus.ShangYe.ToString(), wuYeBianHao);
