...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(ZhiDiExt.ExtNetConfig), "Start")]
    ...
    public static class ExtNetConfig 
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                ...
                new { controller = "TianYuanDataCenter", action = "Index", id = UrlParameter.Optional } // Parameter defaults
            );
        }
